...
class OnDemandEvaluation(BaseEvaluation):
    """
    On_demand evaluation, which is suitable for on_demand approaches.
    ...
    def __init__(self, opt):
        ...
        self.last_display_frame_pts = -1

    def make_evaluation(self):
        """
        Performing evaluation process for on_demand approaches, and recording the evaluation results into JSON file.
        ...
        for motion_ts in motion_clock:
            ...
            frame_idx = int((curr_ts - self.base_ts) * self.video_fps // 1000.0)
        ...
        self.logger.info(f"on_demand evaluation end.")